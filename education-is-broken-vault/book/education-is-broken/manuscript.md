...
The following projections extrapolate from current trends; they are informed estimates, not certainties. In the near term, the most likely scenario is a hybrid world where degrees remain the default for most professional hiring, but skills-based assessments increasingly supplement them. The 81% of employers using skills-based approaches will likely continue to grow, but degree requirements will persist in job listings even as enforcement softens.

If current adoption curves hold, micro-credentials will gain traction in technology, healthcare upskilling, and corporate training -- sectors where specific, current skills matter most. Blockchain credential verification may move from pilot projects to early mainstream adoption, particularly in Europe where regulatory infrastructure is further along.

Portfolios will likely become standard expectations in software, design, and data roles. In other fields, they will probably remain a differentiator rather than a requirement.

The most immediate change will be in how AI reshapes the hiring process itself. With 72% of North American organisations and 59% of European organisations already using AI in HR functions, automated screening is increasingly positioned to evaluate skills evidence alongside -- and sometimes instead of -- credential filters.

### Medium Term (Next 10 Years)

Over the next decade, it is plausible that the signalling stack will become more legible. Quality assurance frameworks for micro-credentials are likely to mature, driven by European regulatory leadership and employer demand for consistency. The European Commission's joint European degree label, rolling out from mid-2026, may establish templates for cross-border credential recognition.

One plausible scenario is that blockchain-based credential wallets become standard infrastructure, enabling learners to accumulate verified credentials from multiple sources -- universities, employers, platforms, professional bodies -- in portable digital portfolios that AI systems can parse automatically.

Behavioural signals may enter mainstream hiring over this period. Adaptive learning platforms, internal mobility systems, and AI-powered career guidance tools are already generating data about how people learn and work. Companies using internal mobility platforms report filling 30-40% of roles internally today, and if this trajectory continues, that proportion will grow as behavioural data improves matching.

It is also plausible that regulated professions will begin exploring competency-based alternatives to traditional degree pathways, though regulatory change will be slow and contested. Some jurisdictions may introduce "alternative qualification pathways" that allow demonstrated competence to substitute for portions of traditional degree requirements.

### Long Term (Next 20 Years)

The following is explicitly speculative -- extrapolating two decades out from current trends involves substantial uncertainty. Over twenty years, if the forces described above continue, the degree's monopoly on professional signalling would substantially weaken outside regulated professions. The signalling stack could mature into a broadly understood, interoperable system where different layers are weighted by context. Hiring a surgeon would still require Layer 1. Hiring a product manager might rely primarily on Layers 2, 3, and 4.

For degrees to truly recede, several structural changes would need to occur: regulatory reform of professional licensing, adaptation of liability and insurance models, shifts in public trust frameworks, and cultural change in how families, communities, and institutions value credentials. These are generational changes, not policy tweaks.

The most transformative -- and most speculative -- possibility is that AI-derived behavioural data becomes reliable and trusted enough to serve as a primary signal for many roles, effectively replacing the degree's function as a proxy for cognitive ability and conscientiousness with direct measurement. This would represent a fundamental shift in how societies sort people into opportunities. Whether it leads to greater meritocracy or to new forms of algorithmic discrimination depends entirely on the governance frameworks we build around it.
