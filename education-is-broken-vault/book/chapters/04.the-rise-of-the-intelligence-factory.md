...
3. **Green 1990** — *Education and State Formation: The Rise of Education Systems in England, France and the USA.* Comparative historical study tracing how state-driven education systems emerged in the 18th--19th centuries, with the Prussian model as the paradigmatic case of compulsory, standardised, age-cohort schooling. **Tier 1** (scholarly monograph by recognised historian of education).
...
6. **Rojstaczer and Healy 2012** — "Where A Is Ordinary: The Evolution of American College and University Grading, 1940--2009." Empirical study in *Teachers College Record* analysing grading data from over 200 US institutions, documenting sustained grade inflation over seven decades. **Tier 1** (peer-reviewed, widely cited).

7. **Christensen and Eyring 2011** — *The Innovative University: Changing the DNA of Higher Education from the Inside Out.* Applies disruptive innovation theory to higher education, arguing that the traditional university bundle will be unbundled by online and modular alternatives. **Tier 2** (book by recognised scholar, influential framing).
...
11. **LinkedIn 2023** — "Skills-First: Reimagining the Labour Market and Breaking Down Barriers." Analysis of hiring patterns across LinkedIn's platform finding significant growth in skills-based job postings and a decline in degree requirements, particularly in the technology sector. **Tier 2** (industry data report with large sample).
