...
*Every innovation in this book risks deepening the divides it claims to close. AI tutoring, peer-driven schools, employer-sponsored degrees, and university alliances all amplify existing conditions: powerful tools given to those with strong foundations produce remarkable results; the same tools without support accelerate disadvantage. Equity must be a binding design constraint, not an afterthought.*
...
27. **Reich and Ruipérez-Valiente 2019** — Peer-reviewed article in *Science* documenting that MOOC benefits flowed overwhelmingly to learners who already held degrees, undermining claims of democratized access. *Tier 1: peer-reviewed empirical analysis in a top-tier journal.*

28. **Scrivener et al. 2015** — MDRC randomized controlled trial of CUNY's Accelerated Study in Associate Programs (ASAP), showing intensive advising and structured support nearly doubled three-year graduation rates for community college students from 22% to 40%. One of the strongest RCTs in higher education intervention research. *Tier 1: randomized controlled trial with replication.*

29. **Roder and Elliott 2019** — Randomised evaluation of Year Up's workforce development program, finding participants earned 30% more than control group members over multiple years. Published by Economic Mobility Corporation. *Tier 1: randomized controlled trial with longitudinal follow-up.*

30. **Merton 1968** — Foundational article in *Science* coining the term "Matthew effect" to describe how initial advantages in scientific recognition compound over time. The concept has been widely adopted across sociology and education research. *Tier 1: seminal peer-reviewed article.*

31. **Posse Foundation 2024** — Institutional reporting from the Posse Foundation describing its cohort-based model for supporting students from under-resourced high schools at selective universities, reporting graduation rates above 90%. *Tier 4: institutional self-reported data.*

32. **AVID 2024** — Institutional website of AVID (Advancement Via Individual Determination) describing its program model for building study skills and collaborative inquiry in secondary school students, reporting reach of over two million students annually. *Tier 4: institutional self-reported data.*
...
Roder, Anne, and Mark Elliott. 2019. *Nine-Year Gains: Year Up's Continued Impact on Young Adults' Earnings*. New York: Economic Mobility Corporation.
