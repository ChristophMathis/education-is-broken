...
*The degree is not dying, but its monopoly is ending. A layered signalling stack is emerging -- degrees, micro-credentials, portfolios, and AI-derived behavioural data -- where different layers carry different weight by profession and career stage. The transition carries real risks of credential inflation and employer confusion without shared quality standards.*

![[signalling-stack-3.png]]
...
For most of human history, you proved competence by doing the work. A blacksmith apprenticed for years, and the village could see whether the horseshoes held. A merchant's reputation was local and personal. Signalling -- the economist's term, formalised by Michael Spence (1973), for communicating your qualities to strangers who cannot directly observe them -- was not a problem because communities were small and information travelled slowly.
...
The Prussian education system of the 18th century established compulsory schooling, standardised curricula, and state certification -- a template that spread globally and entrenched the idea that credentials should be issued by institutions authorised by the state (Green 1990). Over two centuries, this model became so deeply embedded in regulation, professional licensing, and cultural expectation that questioning it felt almost absurd.
...
The strongest version of this argument comes from economist Bryan Caplan, whose *The Case Against Education* (2018) contends that the degree premium is largely a signalling premium: employers reward credentials not because education makes workers more productive, but because completing a degree signals pre-existing traits -- intelligence, conscientiousness, conformity -- that employers value. If Caplan is substantially right, then most of what universities teach is economically irrelevant; the degree functions as an expensive, slow sorting mechanism that could in principle be replaced by cheaper signals.

This book does not adopt Caplan's conclusion, but it takes the signalling critique seriously -- more seriously, in fact, than the human-capital orthodoxy does. The Signalling Stack framework developed later in this chapter implicitly accepts a core Caplan premise: that degrees are valued partly for their signal, not solely for their substance. The question is what follows. Caplan argues for reducing public investment in education. We argue for building better signals. If the degree's value is partly signalling, then the solution is not to abolish the signal but to create signals that are more informative, more granular, and more closely tied to demonstrated capability. A portfolio of shipped projects is a better signal of programming ability than a computer science degree -- not because the degree taught nothing, but because the portfolio shows what the candidate can do now, not what they survived four years ago. The Signalling Stack is, in this sense, a partial answer to Caplan: it accepts the signalling diagnosis while rejecting the nihilistic prescription.

Where the Caplan critique does bite is on the question of public subsidy. If a significant share of the degree's labour-market value comes from signalling rather than human capital formation, then subsidising degrees is partly subsidising a sorting mechanism that could be replaced by cheaper alternatives. This does not mean universities have no value beyond signalling -- research, civic formation, intellectual development, and social mobility are real functions that signalling theory does not capture. But it does mean that the economic case for universal degree subsidies is weaker than policymakers typically assume, and that investment in alternative signalling infrastructure (quality-assured micro-credentials, verifiable portfolios, standardised skills assessments) may deliver more efficient returns.
...
A note on status: Layers 1 through 3 describe observable, currently functioning elements of the hiring landscape. Layer 4 is qualitatively different. It describes a plausible future development, not a current practice. No hiring system currently uses behavioural signals as a primary input at scale. The inclusion of this layer in the stack reflects a directional trend -- not demonstrated adoption. Readers should weight it accordingly.
...
### How Large Is the Degree-Free Labour Market?

The honest answer is: smaller than the skills-based-hiring rhetoric suggests, and larger than sceptics assume.

Across OECD economies, roughly 20–25% of employment sits in regulated or licensed professions where specific degrees remain legal requirements -- medicine, law, engineering, nursing, teaching, pharmacy, accounting, architecture, and their adjacent fields. For these roles, the Signalling Stack does not displace the degree. It supplements it. A surgeon with an excellent portfolio and strong behavioural signals still needs a medical degree. This share of the labour market is unlikely to change substantially within a decade, though competency-based pathways may begin to open at the margins.

At the other end, perhaps 5–8% of employment sits in sectors where portfolio-based hiring is already the dominant practice -- primarily software development, UX/UI design, data science, parts of the creative industries, and some areas of digital marketing. Here, the evidence layer of the Signalling Stack already outweighs the baseline layer. This share is growing, but it remains a small fraction of total employment.
...
Seniority compounds the picture. At entry level, where candidates have little track record, degrees function as the cheapest available filter. The Signalling Stack is weakest here precisely because the other layers -- skills, evidence, behaviour -- have had the least time to accumulate. Mid-career professionals, by contrast, are rarely hired on their degree; track record, network, and demonstrated capability dominate. For senior roles, degrees function as pedigree signals (which school, not which subject) rather than competence signals, and their weight in hiring decisions is marginal compared to reputation and relationships.

The implication is uncomfortable but necessary to state: the Signalling Stack primarily displaces the degree for mid-career professionals in unregulated knowledge work, and for entry-level candidates in a narrow band of portfolio-driven industries. For everyone else -- entry-level candidates in the messy middle, workers in regulated professions, and anyone in a labour market where employer coordination around skills-based hiring has not yet reached critical mass -- the degree remains either a hard gate or a rational default. The Signalling Stack supplements the degree far more often than it replaces it.

This does not mean the shift is trivial. Even partial displacement matters: when skills-based hiring expands candidate pools by 10–17 times in affected roles, the individual and economic impact is significant. But the claim that degrees are "dying" misstates the scale and the timeline. What is dying is the degree's *sufficiency* -- the idea that a degree alone signals everything an employer needs to know. Its *necessity*, in most of the labour market, remains intact.
...
- **Critical counter-evidence:** A 2024 Burning Glass Institute / Harvard Business School study found that removing degree requirements from job postings increased the share of hires without a bachelor's degree by only ~3.5 percentage points per affected role -- fewer than 1 in 700 new hires benefited from these reforms (Sigelman, Fuller, and Martin 2024). This is the strongest available evidence that employer behaviour lags rhetoric by a wide margin, and it directly qualifies the optimism of the self-reported survey data above.
...
- If the credential inflation problem (1 million+ credentials in the U.S. per Credential Engine 2023, 46% of employers unable to assess them) worsens rather than resolves, the signalling stack risks fragmenting instead of maturing.
...
- The signalling theory of education originates with Spence (1973); the strongest contemporary version of the signalling critique is Caplan (2018).
...
- Evidence on the degree premium relies on cross-national labour force surveys and econometric studies of returns to education (OECD 2024).
