...
- Skills-based hiring prevalence and talent pool expansion figures come from TestGorilla's annual State of Skills-Based Hiring report, which surveys employers globally on hiring practices and candidate evaluation methods (Tier 2–3: large-scale multi-employer survey). The gap between reported adoption and actual hiring outcomes is documented by Sigelman, Fuller, and Martin (2024) at the Burning Glass Institute / Harvard Business School, using longitudinal hiring data rather than self-reported surveys (Tier 2: observational hiring data from job postings and employment records).
