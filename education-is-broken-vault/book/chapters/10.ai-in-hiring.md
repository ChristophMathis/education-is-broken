...
*AI now mediates most hiring decisions, from resume parsing to skills assessment. Skills-based hiring is growing, but employer behaviour lags rhetoric -- dropping degree requirements changed actual hiring by only 3.5 percentage points. The EU AI Act and North American approaches diverge sharply, creating a transatlantic regulatory gap that shapes every applicant's experience.*
