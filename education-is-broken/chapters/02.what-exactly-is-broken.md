...
*Education fails on four fronts -- learning outcomes, equity, cost, and labor-market fit -- each reinforcing the others. Seven stakeholder groups experience these failures differently. The underlying cause is structural: institutions designed for a world of scarce, slow information now operate in one of abundance and speed. The mismatch is real, but not permanent.*
...
2. **OECD 2025b** — "How Is Tertiary Education Financed?" Thematic chapter within *Education at a Glance 2025* analyzing tuition levels, public subsidies, student debt, and household spending on higher education across OECD systems. Produced by the OECD. **Tier 2** (cross-national policy analysis drawing on standardized fiscal data).
...
15. **EUA 2024b** — *Designing Strategies for Efficient Funding of Universities in Europe (DEFINE)*. Research project report analyzing funding models, efficiency, and sustainability across European university systems, based on institutional case studies and financial data. Published by the European University Association. **Tier 2** (multi-site research project with systematic methodology).
...
19. **OECD 2025c** — *Trends Shaping Education 2025*. Forward-looking report examining demographic, economic, technological, and environmental megatrends and their implications for education systems worldwide. Produced by the OECD. **Tier 2** (cross-national trend analysis using OECD datasets and scenario modeling).

20. **World Bank 2022** — *The State of Global Learning Poverty: 2022 Update*. Multi-agency report by the World Bank, UNESCO, UNICEF, FCDO, USAID, and the Bill & Melinda Gates Foundation documenting that 70% of ten-year-olds in low- and middle-income countries cannot read and understand a simple text. Introduces the RAPID framework for learning recovery. **Tier 1** (multi-agency empirical report based on nationally representative learning assessments).

21. **Rojstaczer and Healy 2012** — "Where A Is Ordinary: The Evolution of American College and University Grading, 1940--2009." Peer-reviewed study in *Teachers College Record* analyzing grading data from over 200 US institutions across seven decades, documenting sustained grade inflation and its connection to student-as-consumer dynamics. **Tier 1** (peer-reviewed empirical research with large longitudinal dataset).

22. **Koretz 2017** — *The Testing Charade: Pretending to Make Schools Better*. Scholarly monograph published by the University of Chicago Press arguing that high-stakes standardized testing systems measure narrow abilities, incentivize score inflation, and fail to capture genuine cognitive growth. Based on decades of psychometric research. **Tier 1** (peer-reviewed academic monograph by a leading psychometrician).

23. **Maslach and Jackson 1981** — "The Measurement of Experienced Burnout." Foundational peer-reviewed article in the *Journal of Organizational Behavior* defining burnout as a syndrome of emotional exhaustion, depersonalization, and reduced personal accomplishment. Established the Maslach Burnout Inventory (MBI), the most widely used instrument for measuring burnout in education and other helping professions. **Tier 1** (seminal peer-reviewed research, over 20,000 citations).

24. **Ravitch 2013** — *Reign of Error: The Hoax of the Privatization Movement and the Danger to America's Public Schools*. Published by Alfred A. Knopf. Scholarly critique documenting how testing companies, including Pearson, exert significant influence over public education policy, curricula, and assessment systems, often prioritizing commercial interests over educational outcomes. **Tier 2** (book-length scholarly argument by a former US Assistant Secretary of Education).
